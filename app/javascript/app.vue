          ...
          <v-row >
            <v-col class=" d-flex flex-column py-1" cols="12"  sm="12" md="6" lg="7" >
              ...
              <div class="konsultBlock mb-3">
                <v-container>
                <h2>Как проходит консультация?</h2><span>
